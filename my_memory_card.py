...
l = Question('Как меня зовут?','Иван','Дмитрий', 'Сергей', 'Денис')
i = Question("Моя фамилия?", "Останков", 'Кашин', 'Смирнов', 'Алексеев')
k = Question("Моё отчество?", 'Сергеевич', 'Иванович', 'Александрович', 'Иванович')
